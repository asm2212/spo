...
import 'package:spo/data/repository/auth/auth_repository_impl.dart';
...
import 'package:spo/domain/usecases/song/get_news_songs.dart';
import 'package:spo/domain/usecases/song/get_play_list.dart';
import 'package:spo/domain/usecases/song/is_favorite_song.dart';
...
Future<void> initializeDependencies() async {
 ...
 sl.registerSingleton<AuthRepository>(
  AuthRepositoryImpl() as AuthRepository
 );
